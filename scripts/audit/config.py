...
class AuditConfig(BaseModel):
    ...
    dashboard_api_url: str = "http://localhost:3005"
...
def load_config() -> AuditConfig:
    return AuditConfig(
        ...
        dashboard_api_url=os.getenv("AUDIT_DASHBOARD_API_URL", "http://localhost:3005"),
        ...
        jira_project=os.getenv("AUDIT_JIRA_PROJECT", "KAN"),
        slack_channel=os.getenv("AUDIT_SLACK_CHANNEL", "C0A9D3BFK2P"),
        ...
        timeout_execution=float(os.getenv("AUDIT_TIMEOUT_EXECUTION", "600.0")),
